...
def main():
    ...
    try:
        ...
        logger.error(f"Erreur de clé manquante dans la configuration ou les données: {ke_e}. Assurez-vous que toutes les sections et clés nécessaires (ex: [ModelFeatures] depuis pid_model_builder.ini) sont